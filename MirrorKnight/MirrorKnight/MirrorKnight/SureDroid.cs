...
namespace SureDroid
{
    ...
    { 
        ...
        {
            reference = val;
            reference.addEvent(newVal => setVal(newVal));
        }
    ...
    public class Wrapper<T> where T : struct
    {
        ...
        public T Value
        {
            ...
            set
            {
                callbacks?.ForEach(call => call.Invoke(value));
                _t = value;
            }
        }
        ...
        internal void addEvent(Action<T> action)
        {
            if(callbacks== null)
        ...
        internal void removeEvent(Action<T> action)
        {
